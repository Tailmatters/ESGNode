export const LP_GRID_ITEMS = [
  ...
  },
  {
    ...
    description: "Measure waste to landfill - target zero",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description: "Automatically record water consumption metrics",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  {
    title: "Fair Pay and living wages",
    description: "Reduce pay inequitites",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description: "Monitor safety incidents and plan preventive steps",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
